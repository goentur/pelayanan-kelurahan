        ...
        <AuthenticatedLayout header={judul}>
            ...
            <Card>
                ...
                <CardContent>
                    ...
                    <DataTable gate={gate} loading={loading} dataTable={dataTable} dataInfo={dataInfo.from} setForm={setForm} setIsEdit={setIsEdit} setHapus={setHapus} dataPenyampaianKeterangan={dataPenyampaianKeterangan} />
