...
class SpptRepository
{
     ...
     public function data($request)
     {
          ...
          $query = $this->model::select('kd_propinsi', 'kd_dati2', 'kd_kecamatan', 'kd_kelurahan', 'kd_blok', 'no_urut', 'kd_jns_op', 'thn_pajak_sppt', 'nm_wp_sppt', 'jln_wp_sppt', 'blok_kav_no_wp_sppt', 'pbb_yg_harus_dibayar_sppt', 'status_pembayaran_sppt')
               ->where([
                    'kd_propinsi' => $nop[0],
                    'kd_dati2' => $nop[1],
                    'kd_kecamatan' => $nop[2],
